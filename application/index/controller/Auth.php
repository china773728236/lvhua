...
/*
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `lvhua_auth_group`;
  CREATE TABLE `lvhua_auth_group` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `lvhua_auth_group_access`;
  CREATE TABLE `lvhua_auth_group_access` (
